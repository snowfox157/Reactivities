...
public class ProFilesController : BaseApiController
{
    ...
    {
        Console.WriteLine("tsetPhoto!!");
        return HandleResult(await Mediator.Send(new AddPhoto.Command { File = file }));
    }
    [HttpGet("{userId}/photos")]
    public async Task<ActionResult<List<Photo>>> GetPhotsForUser(string userId)
    {
        return HandleResult(await Mediator.Send(new GetProfolePhotos.Query { UserId = userId }));
    }
